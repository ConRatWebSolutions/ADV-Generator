...
class AgreementForm {
        ...
        switch (fieldName) {
            ...
            case 'plz':
                if (!this.isValidPLZ(value)) {
                    errorMessage = 'Bitte geben Sie eine gültige deutsche Postleitzahl ein (5 Ziffern).';
                    isValid = false;
                }
                break;
    ...
    animateProcessSteps() {
        ...
        setTimeout(() => {
            const step1 = document.querySelector('#process-steps .info-step[data-step="1"]');
            if (step1) {
        ...
        setTimeout(() => {
            const step1 = document.querySelector('#process-steps .info-step[data-step="1"]');
            const step2 = document.querySelector('#process-steps .info-step[data-step="2"]');
            if (step1) {
        ...
        setTimeout(() => {
            const step2 = document.querySelector('#process-steps .info-step[data-step="2"]');
            const step3 = document.querySelector('#process-steps .info-step[data-step="3"]');
            if (step2) {
...
window.addEventListener('error', function(event) {
    ...
    if (window.agreementForm) {
        window.agreementForm.showError('Ein unerwarteter Fehler ist aufgetreten. Bitte laden Sie die Seite neu.');
    }
});
...
window.addEventListener('offline', function() {
    if (window.agreementForm) {
        window.agreementForm.showError('Keine Internetverbindung. Bitte überprüfen Sie Ihre Verbindung.');
    }
});
